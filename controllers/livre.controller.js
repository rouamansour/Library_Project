...
export const getLivreByID = async (req, res) => {
    ...
    const liv1 = {
    isbn:isbn,titre:titre,annedition:annedition,prix:prix,qtestock:qtestock,couverture:couverture,specialite:specialite,maised:maised,auteurs:auteurs, _id: id
};
