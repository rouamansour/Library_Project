...
export const getCommandes = async (req, res) => {
    try {
        const comm = await Commande.find().populate('refclient');
...
export const createCommande = async (req, res) => {
    ...
    const newCommande = new Commande({ total: total, refclient: refclient })
    try {
